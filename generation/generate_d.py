...
parser = argparse.ArgumentParser(
    description="Generate a character-level lipogram "
                "with a D constraint."
)
...
The following letter is forbidden:
{forbidden}

The forbidden letter must not appear anywhere in the
generated passage, regardless of capitalization.

Use alternative words, grammatical constructions, or
paraphrases when necessary to avoid the forbidden letter,
