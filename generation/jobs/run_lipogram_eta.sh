...
#SBATCH --output=logs/lipogram_eta_%j.out
#SBATCH --error=logs/lipogram_eta_%j.err

# ============================================================
# LIPOGRAM EXPERIMENT
# Qwen3-32B | eta constraint
# ============================================================
...
"$PYTHON" src/generate.py --constraint eta
