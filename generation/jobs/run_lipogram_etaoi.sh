#!/bin/bash
#SBATCH --job-name=lipogram_etaoi
...
#SBATCH --output=logs/lipogram_etaoi_%j.out
#SBATCH --error=logs/lipogram_etaoi_%j.err

# ============================================================
# LIPOGRAM EXPERIMENT
# Qwen3-32B | etaoi constraint
# ============================================================
...
"$PYTHON" src/generate.py --constraint etaoi
