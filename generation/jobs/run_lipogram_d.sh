...
#SBATCH --output=logs/lipogram_d_%j.out
#SBATCH --error=logs/lipogram_d_%j.err

# ============================================================
# LIPOGRAM EXPERIMENT
# Qwen3-32B | D constraint
# ============================================================
...
"$PYTHON" src/generate_d.py --constraint d
