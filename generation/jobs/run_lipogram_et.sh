...
#SBATCH --output=logs/lipogram_et_%j.out
#SBATCH --error=logs/lipogram_et_%j.err

# ============================================================
# LIPOGRAM EXPERIMENT
# Qwen3-32B | et constraint
# ============================================================
...
"$PYTHON" src/generate.py --constraint et
