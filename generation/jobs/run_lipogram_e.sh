...
#SBATCH --output=logs/lipogram_e_%j.out
#SBATCH --error=logs/lipogram_e_%j.err

# ============================================================
# LIPOGRAM EXPERIMENT
# Qwen3-32B | E constraint
# ============================================================
...
"$PYTHON" src/generate.py --constraint e
