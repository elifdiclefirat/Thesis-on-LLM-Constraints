...
#SBATCH --output=logs/lipogram_etao_%j.out
#SBATCH --error=logs/lipogram_etao_%j.err

# ============================================================
# LIPOGRAM EXPERIMENT
# Qwen3-32B | etao constraint
# ============================================================
...
"$PYTHON" src/generate.py --constraint etao
